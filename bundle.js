...
var polyconvVisitRipple = new _ripple.MDCRipple(document.querySelector('.polyconv__visit'));
var polyconvMoreInfoRipple = new _ripple.MDCRipple(document.querySelector('.polyconv__more-info'));

var centrelineVisitRipple = new _ripple.MDCRipple(document.querySelector('.centreline__visit'));
var centrelineMoreInfoRipple = new _ripple.MDCRipple(document.querySelector('.centreline__more-info'));

var requestAddition = new _ripple.MDCRipple(document.querySelector('.add__request'));
...
var item4Ripple = new _ripple.MDCRipple(document.querySelector('.item4'));

var menuRipple = new _ripple.MDCRipple(document.querySelector('.menu-button'));
menuRipple.unbounded = true;
var backRipple = new _ripple.MDCRipple(document.querySelector('.back-button'));
backRipple.unbounded = true;
var gitRipple = new _ripple.MDCRipple(document.querySelector('.git-button'));
gitRipple.unbounded = true;

// Other Ripples

var polyRipple = new _ripple.MDCRipple(document.querySelector('.polyconv__media'));
